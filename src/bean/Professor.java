...
public class Professor {
	...
	public void setUpTa(){
		...
		qr.updateQueries("INSERRT INTO COURSES_TO_TA VALUSES("+this.id+",'"+course_id+"',"+id+")");
	}
	public void viewReport(){
		System.out.println("Please provide course_id:");
		String course_id=sc.next();
//		ResultSet ws= qr.selectQueries("select e.student_id,s. from students s,enrollment e where e.student_id=s.id and e.course_id='"+course_id+"");
	}
